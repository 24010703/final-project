...
form.addEventListener("submit", function(e) {
  ...
  if (email === FIXED_EMAIL && password === FIXED_PASSWORD) {
    ...
    if (errorP) errorP.textContent = "Use the group account. Email: groupj@gmail.com  password: 1234567890";
    else alert("Use the group account. Email: groupj@gmail.com  password: 1234567890");
  }
});
...
favButton.addEventListener("click", () => {
  ...
  showAllBtn.style.display = "block";     // ⬅️ makes it a block element
showAllBtn.style.margin = "10px auto";  // ⬅️ centers it horizontally
